...
namespace TestNinja.UnitTests.Mocking
{
    ...
    public class BookingHelperTests
    {
        ...
        [Test]
        public void BookingBeforeAndFinishesBeforeAnExistingBooking_ReturnExistingBookingRefrence()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingStartsAndFinishesInTheMiddleOfExistingBooking_ReturnExistingBookingRefrence()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingStartsInTheMiddleOfExistingBookingButFinishesAfter_ReturnExistingBookingRefrence()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
